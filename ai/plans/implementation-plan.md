...
1. 현재 정적 앱 화면을 기준으로 화면/상태/카피를 확정합니다. `docs/mvp/index.html`에서 localStorage mock adapter, 일반 공유 링크, deterministic recommendation, template share copy를 확인할 수 있습니다.
